...
public class PPTimer extends Timer {
    ...
    /**
     * Main entry point for the PPTimer. This program will gather statistics about the execution of the PerfectParallel implementation of the algorithm
     ...
     * - The amount of threads, provided by the 4th parameter.
